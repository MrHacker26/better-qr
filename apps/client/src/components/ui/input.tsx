...
const Input = forwardRef<HTMLInputElement, InputProps>(
  ({ className, style, type, addonBefore, ...props }, ref) => {
    ...
    return (
      <div
        className={cn(
          'border-input focus-within:ring-ring flex h-9 w-full items-center overflow-hidden rounded-md border bg-transparent focus-within:ring-1 focus-within:outline-none',
          className,
        )}
        style={style}
      >
